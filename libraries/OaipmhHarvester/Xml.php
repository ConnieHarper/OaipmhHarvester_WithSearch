<?php /** * @package OaipmhHarvester * @subpackage Libraries * @copyright Copyright (c) 2009 Center for History and New Media * @license http://www.gnu.org/licenses/gpl-3.0.txt */ 
/**
...
class OaipmhHarvester_Xml
{
    ...
    {
        return $this->oaipmh->GetRecord->record;
    }
    ...
    {
	if ($this->oaipmh->ListRecords->record){
        	return $this->oaipmh->ListRecords->record;
	} 
	else
	{
		$returnArray = array();
        	array_push($returnArray,$this->oaipmh->GetRecord->record);
		return $returnArray;
	}
    }
